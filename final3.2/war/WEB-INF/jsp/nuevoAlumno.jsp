...
<h3>Se ha registrado un nuevo alumno satisfacctoriamente.</h3>
<div class="Table">
	<div class="Title"><p>Mostrando datos del alumno: <%=alumno.getNombre() %> <%= alumno.getApellido() %> </p></div>
	<div class="Heading">
...
<%Alumno p = alumno;%>
	<div class="Row">
		...
		<div class="Cell"><p><%= p.getGrado() %></p></div>
		<div class="Cell"><p><%= p.getCorreo() %></p></div>
		<div class="Cell"><p><%= p.getCuenta().getUsuario() %></p></div>
		<div class="Cell"><p><%= p.getCuenta().getContraseña() %></p></div>
	</div>
