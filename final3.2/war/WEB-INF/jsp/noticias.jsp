...
<li class="li_nav_body"><a href="/index.jsp">Inicio</a></li>
<li class="li_nav_body"><a href="/login">Login</a></li>
<li class="li_nav_body"><a href="/getList2">Noticias</a></li>
<li class="li_nav_body"><a href="/galeria">Galeria de fotos</a></li>
<li class="li_nav_footer"><a href="/mapaSitio">Mapa de Sitio</a></li>			 
<%}%>
<%if(misesion.getAttribute("nombre")!=null){%>
<%if(misesion.getAttribute("nombre").equals("yayita")){%>
...
<%}%>		 
<%}%>
<%if(misesion.getAttribute("nombre").equals("severus")||misesion.getAttribute("nombre").equals("albus")){%>
<li class="li_nav_body"><a href="/subirNoticias">Publicar noticias</a></li>
<li class="li_nav_body"><a href="#">Publicar avisos</a></li>
<li class="li_nav_body"><a href="/getList2">Noticias</a></li>
<li class="li_nav_footer"><a href="galeria">Galeria de fotos</a></li>	
<%if(misesion.getAttribute("nombre")!=null){%>
<li class="li_nav_footer"><a href="/cerrar">Cerrar Sesion</a></li>
<%}%>
<%}%>
<%if(!misesion.getAttribute("nombre").equals("severus")&&!misesion.getAttribute("nombre").equals("albus")&&!misesion.getAttribute("nombre").equals("yayita")){%>
...
<h3>Noticias</h3>
<form action="/getList2" method="get">
