...
<%String nuevo=alumno.getNombre();%>
<%sesion.setAttribute("variable", nuevo);%>
...
<div class="clear"></div>
<ul id="nav_list">
<li class="li_nav_body"><a href="/pensiones">Pagar pensiones</a></li> 
<li class="li_nav_body"><a href="/registrarse">Registrar alumnos</a></li>
<li class="li_nav_body"><a href="/getList">Alumnos matriculados</a></li>
<li class="li_nav_body"><a href="/getList2">Noticias</a></li>
<li class="li_nav_body"><a href="/subirNoticias">Publicar noticias</a></li>
...
<h3><%=alumno.getNombre() %></h3><br>
<h3>Registra las siguientes deudas</h3>

<div class="content_box_large">
<div class="Table">
	<div class="Title"><p>DEUDAS AÑO 2015</p></div>
	<div class="Heading">
		<div class="Cell"><p>Mes</p></div>
		<div class="Cell"><p>Monto</p></div>
		<div class="Cell"><p>Saldo</p></div>
	</div>

<%for( Pension p : alumno.getPensiones() ) {%>
	<div class="Row">
		<div class="Cell"><p><%= p.getMes() %></p></div>
		<div class="Cell"><p><%= p.getMonto() %></p></div>
		<div class="Cell"><p><%= p.getSaldo() %></p></div>
	</div>
<%}%>
</div>
</div>
...
Ingrese Monto:<br><input type="text" name="monto"><br>

<input type="submit" value="Aceptar" requested="requested">
